...
monitoring {
  ...
  datadog {
    ...
    image   = "public.ecr.aws/datadog/agent:7.77.1"
...
monitoring_alternatives {
  datadog_dockerhub = "docker.io/datadog/agent:7.77.1"
  datadog_fqdn      = "index.docker.io/datadog/agent:7.77.1"
  datadog_mirror    = "docker.mirror.hashicorp.services/datadog/agent:7.77.1"
