...
monitoring_alternatives {
  datadog_dockerhub = "docker.io/datadog/agent:7.77.2"
  datadog_fqdn      = "index.docker.io/datadog/agent:7.77.2"
  datadog_mirror    = "docker.mirror.hashicorp.services/datadog/agent:7.77.2"
