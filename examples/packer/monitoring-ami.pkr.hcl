...
build {
  ...
  provisioner "shell" {
    inline = [
      "sudo docker pull public.ecr.aws/datadog/agent:7.77.2",
      "sudo docker tag public.ecr.aws/datadog/agent:7.77.2 datadog/agent:latest"
    ]
  }
  ...
  provisioner "shell" {
    inline = [
      ...
      "# docker pull docker.io/datadog/agent:7.77.2",
      "# docker pull index.docker.io/datadog/agent:7.77.2", 
      "# docker pull docker.mirror.hashicorp.services/datadog/agent:7.77.2",
