...
build {
  ...
  provisioner "shell" {
    inline = [
      "sudo docker pull public.ecr.aws/datadog/agent:7.82.0",
      "sudo docker tag public.ecr.aws/datadog/agent:7.82.0 datadog/agent:latest"
    ]
  }
  ...
  provisioner "shell" {
    inline = [
      ...
      "# docker pull docker.io/datadog/agent:7.82.0",
      "# docker pull index.docker.io/datadog/agent:7.82.0", 
      "# docker pull docker.mirror.hashicorp.services/datadog/agent:7.82.0",
